...
import (
	...
	crd "github.com/Shanghai-Lunara/helixsaga-operator/pkg/controllers/helixsaga"
...
func main() {
	...
	controller := crd.NewController("helix-saga-controller", kubeClient, exampleClient, stopCh)
